(function ($) {
    ...
    var Mistape_Admin = {
        ...
        init: function () {
            ...
            $('#preview-dialog-btn').on('click', function (e) {
                ...
                Mistape_Admin.previewDialog(mode);
            });
            ...
            $('.nav-tab').click(function (ev) {
                ...
                if (!$(this).hasClass('nav-tab-active')) {
                    ...
                    Mistape_Admin.ChangeUrl($(this).text(), $(this).attr('href'));
                }
            });
            ...
            colorPickerInp.wpColorPicker({
                change: function () {
                    setTimeout(function () {
                        Mistape_Admin.colorScheme($('.mistape_color_picker').val());
                    }, 10);

                }
            });
            Mistape_Admin.colorScheme(colorPickerInp.val());
        },
    ...
    $(document).ready(Mistape_Admin.init);
