...
abstract class Mistape_Abstract
{
	...
	public function get_dialog_html($args = array())
	{
		...
		if ($args['mode'] === 'notify') {
	    	...
	    	<div class="mistape_dialog_btn_block">
				...
				<div id="mistape-close-btn" class="mistape-close__btn">
	...
	public function enqueue_dialog_assets()
	{
		...
		wp_enqueue_script(
			'mistape-front',
			plugins_url('assets/js/mistape-front.js', self::$plugin_path),
			array(
				'jquery',
				'modernizr'
			),
